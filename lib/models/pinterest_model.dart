...
List<Pinterest> pictureFromJson(String str) => List<Pinterest>.from(json.decode(str).map((x) => Pinterest.fromJson(x)));
String pictureToJson(List<Pinterest> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class Pinterest {
  ...
  Pinterest({this.id, this.createdAt, this.updatedAt, this.promotedAt, this.width, this.height, this.color, this.blurHash, this.description, this.altDescription, this.urls, this.links, this.categories, this.likes, this.likedByUser, this.currentUserCollections, this.sponsorship, this.topicSubmissions, this.user});
  ...
  Pinterest.fromJson(Map<String, dynamic> json) {
    ...
    if (json['categories'] != null) {
      categories = <dynamic>[];
      json['categories'].forEach((v) { categories!.add( TopicSubmissions.fromJson(v)); });
    }
    likes = json['likes'];
    likedByUser = json['liked_by_user'];
    if (json['current_user_collections'] != null) {
      currentUserCollections = <Null>[];
      json['current_user_collections'].forEach((v) { currentUserCollections!.add(TopicSubmissions.fromJson(v)); });
    }
...
class ShortLinks {
  ...
  ShortLinks({this.self, this.html, this.download, this.downloadLocation});

  ShortLinks.fromJson(Map<String, dynamic> json) {
    self = json['self'];
    html = json['html'];
