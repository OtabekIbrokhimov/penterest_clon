...
List<Autogenerated> searchFromJson(String str) => List<Autogenerated>.from(json.decode(str).map((x) => Autogenerated.fromJson(x)));
 String searchToJson(List<Autogenerated> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

 List<Results> searchResultsFromJson(String str) => List<Results>.from(json.decode(str).map((x) => Results.fromJson(x)));
 String searchToResultsJson(List<Results> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
 ...
 class Autogenerated {
  ...
  Autogenerated({this.total, this.totalPages, this.results});
...
class Results {
  ...
  Results({this.id, this.createdAt, this.updatedAt, this.promotedAt, this.width, this.height, this.color, this.blurHash, this.description, this.altDescription, this.urls, this.links, this.categories, this.likes, this.likedByUser, this.currentUserCollections, this.sponsorship, this.topicSubmissions, this.user, this.tags});
...
class Linkx {
  ...
  Linkx({this.self, this.html, this.photos, this.likes, this.portfolio, this.following, this.followers});

  Linkx.fromJson(Map<String, dynamic> json) {
    self = json['self'];
    html = json['html'];
    photos = json['photos'];
    likes = json['likes'];
...
class CoverPhoto {
  ...
  CoverPhoto({this.id, this.createdAt, this.updatedAt, this.promotedAt, this.width, this.height, this.color, this.blurHash, this.description, this.altDescription, this.urls, this.links, this.categories, this.likes, this.likedByUser, this.currentUserCollections, this.sponsorship, this.topicSubmissions, this.user});
...
class TopicSubmissions2 {
  ...
  TexturesPatterns? artsCulture;

  TopicSubmissions2({this.texturesPatterns, this.wallpapers, this.artsCulture});

  TopicSubmissions2.fromJson(Map<String, dynamic> json) {
    texturesPatterns = json['textures-patterns'] != null ? new TexturesPatterns.fromJson(json['textures-patterns']) : null;
    wallpapers = json['wallpapers'] != null ? new TexturesPatterns.fromJson(json['wallpapers']) : null;
    artsCulture = json['arts-culture'] != null ? new TexturesPatterns.fromJson(json['arts-culture']) : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.artsCulture != null) {
      data['arts-culture'] = this.artsCulture!.toJson();
    }
    return data;
  }
}
...
class TexturesPatterns {
  ...
  TexturesPatterns({this.status, this.approvedOn});
...
class Ancestry2 {
  ...
  Ancestry2({this.type, this.category, this.subcategory});

  Ancestry2.fromJson(Map<String, dynamic> json) {
    type = json['type'] != null ? new Type.fromJson(json['type']) : null;
    category = json['category'] != null ? new Type.fromJson(json['category']) : null;
    subcategory = json['subcategory'] != null ? new Type.fromJson(json['subcategory']) : null;
  }
...
class TopicSubmissions3 {
  TexturesPatterns? texturesPatterns;
  TexturesPatterns? wallpapers;
  TexturesPatterns? artsCulture;

  TopicSubmissions3({this.texturesPatterns, this.wallpapers, this.artsCulture});

  TopicSubmissions3.fromJson(Map<String, dynamic> json) {
    texturesPatterns = json['textures-patterns'] != null ? new TexturesPatterns.fromJson(json['textures-patterns']) : null;
    wallpapers = json['wallpapers'] != null ? new TexturesPatterns.fromJson(json['wallpapers']) : null;
    artsCulture = json['arts-culture'] != null ? new TexturesPatterns.fromJson(json['arts-culture']) : null;
  }
